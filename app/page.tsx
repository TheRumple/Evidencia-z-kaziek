...
export default function Page() {
  ...
  function exportOrderWorkLogsPdf(orderId: string) {
    ...
    printWindow.document.write(`
      <html>
        <head>
          <title>Podklad k zákazke - ${order.nazov}</title>
          <style>
body { font-family: Arial, Helvetica, sans-serif; color: #0f172a; margin: 28px; }

.headerTop { display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:8px; }
.logo { width:60px; }
.company { font-size:11px; line-height:1.3; text-align:right; color:#475569; }

h1 { margin:8px 0 10px 0; font-size:22px; }
...
.summary { margin: 14px 0 12px 0; padding: 10px 12px; background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 10px; }
...
<div class="header">
  <div class="headerTop">
    ...
    <div class="company">
      <span style='font-weight:800;font-size:13px;'>ITspot s. r. o.</span><br/>
...
<div class="signatures">
  ...
  <div class="signBlock">
    ...
    <div class="signLine" style="margin-top:60px;"></div>
